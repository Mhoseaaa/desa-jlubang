/* ========================================================
   ...
   Data realistis untuk Dusun Citrowonodadi, Desa Jlubang (Pringkuku, Pacitan)
   ======================================================== */
...
export const mockDusunList: Dusun[] = [
  {
    id: 1, slug: 'citrowonodadi', name: 'Dusun Citrowonodadi',
    description: 'Dusun Citrowonodadi merupakan dusun di Desa Jlubang, Kecamatan Pringkuku, Kabupaten Pacitan, dengan kontur perbukitan khas dan kekayaan budaya serta UMKM warganya.',
    history: 'Dusun Citrowonodadi terbentuk dari dua area permukiman yang menyatu: bagian selatan sebagai permukiman utama yang dikenal dengan nama "Citro", dan bagian utara sebagai permukiman yang berkembang lebih kemudian dengan nama "Wonodadi". Kedua nama ini digabung menjadi identitas satu dusun yang dikenal hingga sekarang.\n\nSejak dahulu, warga Citrowonodadi dikenal dengan semangat gotong royong dan kebersamaan yang kuat. Nilai-nilai luhur ini terus dilestarikan hingga saat ini sebagai fondasi membangun dusun menuju kemajuan.',
    imageUrl: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80',
    // Approximate coordinate (geocoded village-level point for "Jlubang, Pacitan" via OpenStreetMap Nominatim).
    // TODO: replace with the precise dusun-center pin once available.
    latitude: -8.209, longitude: 111.0062, headName: 'Bpk. Suroto',
...
export const mockGovernment: GovernmentMember[] = [
  ...
  { id: 4, name: 'Bpk. Suroto', role: 'Kepala Dusun Citrowonodadi', period: '2024–2030' },
  { id: 5, name: 'Ibu Sumarni', role: 'Kaur Perencanaan', period: '2024–2030' },
];
...
export const mockNews: NewsArticle[] = [
  ...
  },
  {
    ...
    excerpt: 'Proyek jalan penghubung ke pusat desa sepanjang 3 km selesai, memperlancar akses transportasi dan ekonomi warga.',
    content: `<p>Proyek pembangunan jalan penghubung sepanjang 3 kilometer akhirnya rampung. Jalan ini menghubungkan Dusun Citrowonodadi langsung dengan pusat Desa Jlubang.</p><p>Pembangunan ini merupakan hasil kolaborasi pemerintah desa, kabupaten, dan swadaya masyarakat.</p>`,
  ...
  {
    id: 5, slug: 'panen-raya-padi-organik', title: 'Panen Raya Padi Organik Dusun Citrowonodadi, Hasil Meningkat 30%',
    excerpt: 'Program pertanian organik selama 3 tahun di Dusun Citrowonodadi menunjukkan peningkatan hasil panen hingga 30%.',
    content: `<p>Dusun Citrowonodadi berhasil panen raya padi organik dengan peningkatan hasil 30%. Beras organik Citrowonodadi mulai diminati pasar yang lebih luas.</p>`,
...
export const mockUMKMItems: UMKMItem[] = [
  {
    id: 1, slug: 'batik-citro', name: 'Batik Citro', description: 'Batik khas Dusun Citrowonodadi dengan motif terinspirasi alam dan budaya lokal. Diproduksi secara tradisional oleh para pengrajin batik yang sudah turun-temurun menjaga warisan budaya.',
    imageUrl: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=800&q=80', images: [], category: 'Kerajinan', owner: 'Ibu Sartini', phone: '0812-3456-7890', address: 'RT 02/RW 01, Dusun Citrowonodadi', products: ['Batik Tulis', 'Batik Cap', 'Kain Panjang', 'Selendang'],
    latitude: -8.208, longitude: 111.005, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&q=80', images: [], category: 'Kerajinan', owner: 'Bpk. Darmo', phone: '0813-4567-8901', address: 'RT 04/RW 02, Dusun Citrowonodadi', products: ['Relief Dinding', 'Patung', 'Furniture', 'Souvenir'],
    latitude: -8.210, longitude: 111.007, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1563822249366-3efb23b8e0c9?w=800&q=80', images: [], category: 'Kuliner', owner: 'Ibu Sumi', phone: '0852-3456-7890', address: 'RT 01/RW 01, Dusun Citrowonodadi', products: ['Kunyit Asam', 'Beras Kencur', 'Temulawak', 'Wedang Jahe'],
    latitude: -8.207, longitude: 111.004, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&q=80', images: [], category: 'Kuliner', owner: 'Bpk. Sugeng', phone: '0813-5678-9012', address: 'RT 04/RW 02, Dusun Citrowonodadi', products: ['Kopi Bubuk', 'Kopi Biji', 'Green Bean', 'Drip Bag'],
    latitude: -8.214, longitude: 111.011, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1621447504864-d8686e12698c?w=800&q=80', images: [], category: 'Kuliner', owner: 'Ibu Darmi', phone: '0856-7890-1234', address: 'RT 01/RW 01, Dusun Citrowonodadi', products: ['Original', 'Pedas', 'Keju', 'Balado', 'BBQ'],
    latitude: -8.212, longitude: 111.009, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?w=800&q=80', images: [], category: 'Kesehatan', owner: 'Bpk. Warsito', phone: '0878-9012-3456', address: 'RT 05/RW 03, Dusun Citrowonodadi', products: ['Madu 250ml', 'Madu 500ml', 'Madu 1L', 'Sarang Madu'],
    latitude: -8.215, longitude: 111.012, dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
];
...
export const mockWisataItems: WisataItem[] = [
  {
    ...
    latitude: -8.208, longitude: 111.005, address: 'RT 02/RW 01, Dusun Citrowonodadi', rating: 4.4,
    dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi', googleMapsUrl: 'https://maps.google.com/?q=-8.208,111.005',
  },
  {
    ...
    latitude: -8.210, longitude: 111.007, address: 'RT 04/RW 02, Dusun Citrowonodadi', rating: 4.2,
    dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi', googleMapsUrl: 'https://maps.google.com/?q=-8.210,111.007',
  },
  {
    ...
    latitude: -8.216, longitude: 111.013, address: 'RT 06/RW 04, Dusun Citrowonodadi', rating: 4.7,
    dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi', googleMapsUrl: 'https://maps.google.com/?q=-8.216,111.013',
  },
  {
    ...
    latitude: -8.217, longitude: 111.014, address: 'RT 05/RW 03, Dusun Citrowonodadi', rating: 4.5,
    dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi', googleMapsUrl: 'https://maps.google.com/?q=-8.217,111.014',
  },
  {
    ...
    latitude: -8.214, longitude: 111.016, address: 'RT 03/RW 02, Dusun Citrowonodadi', rating: 4.6,
    dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi', googleMapsUrl: 'https://maps.google.com/?q=-8.214,111.016',
  },
];
...
export const mockKebudayaan: KebudayaanItem[] = [
  {
    ...
    content: '<p>Tari Gambyong Citro merupakan tarian khas Dusun Citrowonodadi yang dibawakan oleh para penari wanita. Gerakan lemah gemulai menggambarkan keanggunan dan keramahan warga dusun.</p><p>Tarian ini biasanya ditampilkan pada acara penyambutan tamu agung, festival budaya, dan peringatan hari besar desa.</p>',
    imageUrl: 'https://images.unsplash.com/photo-1565967511849-76a60a516170?w=800&q=80', images: [], category: 'kesenian', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    id: 2, slug: 'batik-motif-citro', title: 'Batik Motif Khas Citro', description: 'Motif batik unik yang terinspirasi dari flora dan fauna sekitar Dusun Citrowonodadi.',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=800&q=80', images: [], category: 'kerajinan', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1563822249366-3efb23b8e0c9?w=800&q=80', images: [], category: 'makanan', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=800&q=80', images: [], category: 'tradisi', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    id: 5, slug: 'reog-wonodadi', title: 'Reog Wonodadi', description: 'Kesenian Reog yang telah dipertahankan secara turun-temurun oleh warga Dusun Citrowonodadi.',
    content: '<p>Reog Wonodadi merupakan kesenian yang menjadi identitas budaya Dusun Citrowonodadi. Pertunjukan ini menampilkan tarian, musik gamelan, dan atraksi topeng.</p>',
    imageUrl: 'https://images.unsplash.com/photo-1565967511849-76a60a516170?w=800&q=80', images: [], category: 'kesenian', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
  {
    id: 6, slug: 'legenda-telaga-biru', title: 'Legenda Telaga Biru', description: 'Cerita rakyat tentang asal-usul Telaga Biru yang dipercaya warga Citrowonodadi.',
    ...
    imageUrl: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&q=80', images: [], category: 'cerita-rakyat', dusunSlug: 'citrowonodadi', dusunName: 'Dusun Citrowonodadi',
  },
];
...
export const mockAgendaItems: AgendaItem[] = [
  ...
  { id: 3, title: 'Pelatihan Pertanian Organik', description: 'Pelatihan teknik pertanian organik untuk kelompok tani, bekerja sama dengan Dinas Pertanian.', date: '2026-07-20', time: '08:00 - 15:00 WIB', location: 'Balai Dusun Citrowonodadi', category: 'Pertanian', status: 'upcoming' },
...
export const mockGallery: GalleryItem[] = [
  { id: 1, title: 'Pemandangan Sawah', caption: 'Hamparan sawah hijau di Desa Jlubang', imageUrl: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=400&q=80', altText: 'Sawah hijau', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
  { id: 2, title: 'Air Terjun Wonodadi', caption: 'Air terjun alami yang memukau', imageUrl: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=400&q=80', altText: 'Air terjun', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
  { id: 3, title: 'Gotong Royong', caption: 'Warga bergotong royong', imageUrl: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=400&q=80', altText: 'Gotong royong', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
  ...
  { id: 6, title: 'Hutan Pinus', caption: 'Hutan pinus yang asri', imageUrl: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&q=80', altText: 'Hutan pinus', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
  { id: 7, title: 'Telaga Biru', caption: 'Telaga biru yang jernih', imageUrl: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=400&q=80', altText: 'Telaga biru', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
  { id: 8, title: 'Batik Citro', caption: 'Proses pembuatan batik', imageUrl: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=800&q=80', thumbnailUrl: 'https://images.unsplash.com/photo-1558171813-4c088753af8f?w=400&q=80', altText: 'Batik Citro', width: 800, height: 533, dusunSlug: 'citrowonodadi' },
];
